...
class AP_block(nn.Module):
    ...
    def __init__(self):
        ...
        # Upscaling
        self.W1 = nn.Conv1d(C_a, C_a, kernel_size=5, padding=2, groups=C_a)

        self.W2 = nn.Conv1d(C_a, C_a, kernel_size=5, padding=2, groups=C_a)

        self.W3 = nn.Conv1d(C_a, C_a, kernel_size=5, padding=2, groups=C_a)
